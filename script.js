 ...
 */
const myFavoriteSong = 'Pyramid Song'
console.log(`My favorite song is ${myFavoriteSong} by Radiohead`)
/*
 * Prompt 2:
 *
 * Create 3 variables using let and const, then console.log each of them, using a string literal (` ${} `} in the log
 */
let favoriteFilm = 'Eternal Sunshine Of THe Spotless Mind'
console.log(`${favoriteFilm}`)
const favoriteAuthor = 'Haruki Murakami'
console.log(`${favoriteAuthor}`)
let favoriteFestival = 'Coachella'
console.log(`${favoriteFestival}`)
/*
 * Prompt 3:
 *
...
let movies = ['Eternal Sunshine', 'Do The Right Thing', 'Get Out','Beverly Hills Cop']
console.log(movies[1])
movies.unshift('Everything Everywhere All At Once')
movies.push('Black Orpheus')
movies.splice([1], 0, 'The Seventh Seal')
console.log(movies)
/*
 *
